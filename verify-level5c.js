...
const fileData = fs.readFileSync('words-level5c.js', 'utf8');
...
let report = "# VERIFY-GEMINI-words-level5c.js-GATE\n\n";
...
fs.writeFileSync('VERIFY-GEMINI-words-level5c.js-GATE.md', report);
