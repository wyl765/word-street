...
const fileContent = fs.readFileSync('./words-level4b.js', 'utf8');
const match = fileContent.match(/const LEVEL4B_BANK\s*=\s*(\[[\s\S]*\]);/);
...
let output = '# Gemini Verification Report: words-level4b.js\n\n';
...
fs.writeFileSync('VERIFY-GEMINI-words-level4b-GATE.md', output);
