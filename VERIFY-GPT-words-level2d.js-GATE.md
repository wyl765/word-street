...
019 pledge | L5: def=懂; ex=不能(定义直白且场景常见) | L6: 相对唯一(大致能猜，但仍可能被近义/同类词误选); 选项: [plea / pace / privilege / pledge] | L7: OK(无明显文化冲突) | L8: 合适(可作为高频基础学术词/课堂用语扩展)
...
094 reside | L5: def=懂; ex=不能(定义直白且场景常见) | L6: 相对唯一(大致能猜，但仍可能被近义/同类词误选); 选项: [reside / resolve / reserve / resist] | L7: OK(无明显文化冲突) | L8: 合适(可作为高频基础学术词/课堂用语扩展)
...
157 threaten | L5: def=勉强; ex=不能(词形偏长或概念偏抽象，需要更多图示/对比例子) | L6: 不唯一(线索不够唯一，容易被同类词干扰); 选项: [thrive / threaten / transfer / tolerate] | L7: 注意(注意(“hurt someone”需避免暴力细节；可保留自然现象例句)) | L8: 勉强(建议放在更具体、更常见词之后，并配图/对比例句)
