...
The word "communique" doesn't appear in any form in the example: "The government issued a communiqué about the new safety regu..."
**Fix:** Rewrite example to include the target word

### [MAJOR] words-level5c.js — "cliche" (WORD_NOT_IN_EXAMPLE)
The word "cliche" doesn't appear in any form in the example: "Saying 'easy as pie' is a cliché that everyone has heard bef..."
**Fix:** Rewrite example to include the target word

### [MINOR] words-level5c.js — "utopia" (ARTICLE_ERROR)
Possible "a/an" error: "a utopia"
**Fix:** Consider "an utopia"

### [MINOR] words-level5d.js — "integration" (ARTICLE_ERROR)
Possible "a/an" error: "a unified"
**Fix:** Consider "an unified"
...
L2 definition uses complex word(s): constitution
**Fix:** Simplify definition for young learners
