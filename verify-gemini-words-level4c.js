...
const fileContent = fs.readFileSync('./words-level4c.js', 'utf8');
const match = fileContent.match(/const LEVEL4C_BANK\s*=\s*(\[[\s\S]*\]);/);
...
let output = '# Gemini Verification Report: words-level4c.js\n\n';
...
fs.writeFileSync('VERIFY-GEMINI-words-level4c-GATE.md', output);
