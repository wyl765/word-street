...
export declare class EventSigningTransformStream extends TransformStream<Uint8Array, Uint8Array> {
    ...
    constructor(initialSignature: string, messageSigner: MessageSigner, eventStreamCodec: EventStreamCodec, systemClockOffsetProvider: Provider<number>, credentials?: AwsCredentialIdentityProvider);
}
