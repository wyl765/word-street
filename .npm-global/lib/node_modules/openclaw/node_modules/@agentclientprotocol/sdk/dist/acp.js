        ...
        const requestHandler = async (method, params) => {
            switch (method) {
                ...
                case schema.AGENT_METHODS.providers_disable: {
                    ...
                    const validatedParams = validate.zDisableProvidersRequest.parse(params);
...
export class ClientSideConnection {
    ...
    async unstable_listProviders(params) {
        return await this.connection.sendRequest(schema.AGENT_METHODS.providers_list, params);
    }
    /**
     * **UNSTABLE**
     *
    ...
    async unstable_setProvider(params) {
        return ((await this.connection.sendRequest(schema.AGENT_METHODS.providers_set, params)) ?? {});
    }
    /**
     * **UNSTABLE**
     *
    ...
    async unstable_disableProvider(params) {
        return ((await this.connection.sendRequest(schema.AGENT_METHODS.providers_disable, params)) ?? {});
    }
    /**
