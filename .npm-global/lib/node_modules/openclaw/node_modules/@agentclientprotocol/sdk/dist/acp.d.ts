...
export declare class ClientSideConnection implements Agent {
     ...
     * @experimental
     */
    unstable_setProvider(params: schema.SetProvidersRequest): Promise<schema.SetProvidersResponse>;
    /**
     * **UNSTABLE**
     *
     * This capability is not part of the spec yet, and may be removed or changed at any point.
     ...
     * @experimental
     */
    unstable_disableProvider(params: schema.DisableProvidersRequest): Promise<schema.DisableProvidersResponse>;
    /**
...
declare class Connection {
    ...
    private tryCallRequestHandler;
    private tryCallNotificationHandler;
...
export interface Agent {
     ...
     * and then free up any resources associated with the session.
     */
    closeSession?(params: schema.CloseSessionRequest): Promise<schema.CloseSessionResponse | void>;
    /**
     * Sets the operational mode for a session.
     *
     * Allows switching between different agent modes (e.g., "ask", "architect", "code")
     ...
     * @experimental
     */
    unstable_setProvider?(params: schema.SetProvidersRequest): Promise<schema.SetProvidersResponse | void>;
    /**
     * **UNSTABLE**
     *
     * This capability is not part of the spec yet, and may be removed or changed at any point.
     ...
     * @experimental
     */
    unstable_disableProvider?(params: schema.DisableProvidersRequest): Promise<schema.DisableProvidersResponse | void>;
    /**
     * Terminates the current authenticated session.
     *
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
