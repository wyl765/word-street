...
import { t as COGNITIVE_SERVICES_RESOURCE } from "./shared-CIy1QbVT.js";
...
function getAccessTokenResult(params) {
	return JSON.parse(execAz(buildAccessTokenArgs(params)));
}
async function getAccessTokenResultAsync(params) {
	return JSON.parse(await execAzAsync(buildAccessTokenArgs(params)));
}
