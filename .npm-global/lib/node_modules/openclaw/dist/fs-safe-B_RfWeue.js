...
import { a as hasNodeErrorCode, c as isSymlinkOpenError, n as resolveBoundaryPath, o as isNotFoundPathError, s as isPathInside } from "./boundary-path-DbcMiy8Y.js";
import { n as sameFileIdentity } from "./safe-open-sync-BVLkOkpr.js";
import { a as logWarn } from "./logger-DksTYIAF.js";
import { n as assertNoPathAliasEscape, t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Ler1jnsE.js";
...
async function openVerifiedLocalFile(filePath, options) {
	...
	try {
		...
		if (options?.allowSymlinkTargetWithinRoot) {
			if (!sameFileIdentity(stat, await fs$1.stat(filePath))) throw new SafeOpenError("path-mismatch", "path changed during read");
		} else {
