...
import { a as createSetupInputPresenceValidator, l as patchScopedAccountConfig, t as applyAccountNameToChannelSection } from "./setup-helpers-CZcbnIfg.js";
...
import { J as setSetupChannelEnabled, a as createAllowFromSection, d as createPromptParsedAllowFromForAccount, f as createStandardChannelSetupStatus, h as createTopLevelChannelDmPolicySetter, p as createTopLevelChannelAllowFromSetter } from "./setup-wizard-helpers-6I3G81wu.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-SmMNqErm.js";
import { d as createDefaultChannelRuntimeState, n as buildBaseChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-BthQYPrV.js";
...
import { h as runStoppablePassiveMonitor } from "./extension-shared-DA6ep8iB.js";
import "./channel-lifecycle-DlWmGQsl.js";
import { _ as resolveDefaultIrcAccountId, a as resolveIrcGroupMatch, c as resolveIrcRequireMention, d as normalizeIrcAllowEntry, g as listIrcAccountIds, l as isChannelTarget, n as connectIrcClient, p as normalizeIrcMessagingTarget, t as buildIrcConnectOptions, u as looksLikeIrcTargetId, v as resolveIrcAccount } from "./connect-options-3gcZ1qXE.js";
import { t as IrcChannelConfigSchema } from "./config-schema-nMOjMjDV.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-WqlWF-5Y.js";
...
async function loadIrcChannelRuntime$1() {
	ircChannelRuntimePromise$1 ??= import("./channel-runtime-uA2n51L8.js");
...
const ircSetupAdapter = {
	...
	validateInput: createSetupInputPresenceValidator({ whenNotUseEnv: [{
		someOf: ["host"],
...
async function loadIrcChannelRuntime() {
	ircChannelRuntimePromise ??= import("./channel-runtime-uA2n51L8.js");
...
//#endregion
export { ircSetupWizard as n, ircSetupAdapter as r, ircPlugin as t };
