...
import { d as resolveThreadSessionKeys$1 } from "./session-key-C0K0uhmG.js";
...
import { u as isReasoningReplyPayload } from "./reply-payload-CShZCAWP.js";
...
import { C as resolveChannelStreamingPreviewToolProgress, s as formatChannelProgressDraftLineForEntry } from "./channel-streaming-B7SapjwD.js";
import "./text-runtime-DiIsWJZ1.js";
import "./routing-CFCE0Z1M.js";
import "./error-runtime-9blOJmKj.js";
import { i as formatInboundFromLabel$1 } from "./envelope-DDby4aj3.js";
...
import { a as warnMissingProviderGroupPolicyFallbackOnce, n as resolveAllowlistProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-DMTxD3cx.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-d9yDWXE5.js";
import { l as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists, t as DM_GROUP_ACCESS_REASON } from "./dm-policy-shared-D7EtFi3S.js";
...
import { f as ssrfPolicyFromPrivateNetworkOptIn, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-DXzuOZEO.js";
...
import { c as deliverFinalizableDraftPreview, r as createFinalizableDraftLifecycle } from "./channel-lifecycle-DlWmGQsl.js";
import { t as createClaimableDedupe } from "./persistent-dedupe-D5MBWylw.js";
import { t as zod_exports } from "./zod-BmdmMXjZ.js";
import { i as normalizeMattermostAllowList, n as isMattermostSenderAllowed, r as normalizeMattermostAllowEntry, t as authorizeMattermostCommandInvocation } from "./monitor-auth-B7mLQc8k.js";
	...
	const handlePost = async (post, payload, messageIds) => {
		...
		if (await processMattermostReplayGuardedPost({
			...
			handlePost: async () => {
				...
				const channelInfo = await resolveChannelInfo(channelId);
				const kind = resolveMattermostTrustedChatKind({ channelType: channelInfo?.type });
				const chatType = channelChatType(kind);
									...
									run: () => core.channel.reply.dispatchReplyFromConfig({
										...
										replyOptions: {
											...
											onPartialReply: (payload) => {
												if (account.streamingMode !== "progress") updateDraftFromPartial(payload.text);
											},
