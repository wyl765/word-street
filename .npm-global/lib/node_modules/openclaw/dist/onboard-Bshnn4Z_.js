import { n as applyAgentDefaultModelPrimary, r as applyOnboardAuthAgentModelsAndProviders } from "./provider-onboard-BFSKJZVe.js";
import { i as MINIMAX_API_BASE_URL, m as buildMinimaxApiModelDefinition, s as MINIMAX_CN_API_BASE_URL } from "./model-definitions-BjulAIvV.js";
...
function applyMinimaxApiProviderConfig(cfg, modelId = "MiniMax-M2.7") {
...
function applyMinimaxApiProviderConfigCn(cfg, modelId = "MiniMax-M2.7") {
	return applyMinimaxApiProviderConfigWithBaseUrl(cfg, {
		providerId: "minimax",
		modelId,
