...
import { t as require_extend } from "./extend-c9WMfGIu.js";
	...
	*/
	function defaultErrorRedactor(data) {
		...
		if (data.config) {
			...
			try {
				const url = new url_1$1.URL("", data.config.url);
...
var require_gaxios = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const querystring_1 = __importDefault(__require("querystring"));
	...
	const uuid_1 = (init_dist_node(), __toCommonJS(dist_node_exports));
	...
	_a = Gaxios, _Gaxios_instances = /* @__PURE__ */ new WeakSet(), _Gaxios_urlMayUseProxy = function _Gaxios_urlMayUseProxy(url, noProxy = []) {
		...
		__classPrivateFieldSet(this, _a, __classPrivateFieldGet(this, _a, "f", _Gaxios_proxyAgent) || (await Promise.resolve().then(() => __importStar(__require("https-proxy-agent")))).HttpsProxyAgent, "f", _Gaxios_proxyAgent);
