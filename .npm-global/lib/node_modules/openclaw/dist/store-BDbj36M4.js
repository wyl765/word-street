...
import { s as writeTextAtomic } from "./json-files-DPM4MwsB.js";
import { t as createSubsystemLogger } from "./subsystem-CxWoQXRD.js";
import { l as listDeliverableMessageChannels, u as normalizeMessageChannel } from "./message-channel-n3msLZX9.js";
import { i as isSessionArchiveArtifactName, n as isCompactionCheckpointTranscriptFileName, r as isPrimarySessionTranscriptFileName, s as isTrajectorySessionArtifactName } from "./artifacts-CWcY_c7b.js";
...
import { S as getFileStatSnapshot, _ as isSessionStoreCacheEnabled, a as getActiveSessionMaintenanceWarning, b as writeSessionStoreCache, g as getSerializedSessionStore, h as dropSessionStoreObjectCache, i as capEntryCount, l as shouldRunSessionEntryMaintenance, n as normalizeSessionStore, o as isProtectedSessionMaintenanceEntry, p as clearSessionStoreCaches, r as resolveMaintenanceConfig, s as pruneStaleEntries, t as loadSessionStore, v as setSerializedSessionStore, y as takeMutableSessionStoreCache } from "./store-load-Dys5caP1.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin } from "./registry-Cj-R885W.js";
import { n as mergeSessionEntry, r as mergeSessionEntryPreserveActivity } from "./types-CM03LxPM.js";
...
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath } from "./paths-C5hWOZQS.js";
...
async function enforceSessionDiskBudget(params) {
	...
	const removableFileQueue = files.filter((file) => isSessionArchiveArtifactName(file.name) || isCompactionCheckpointTranscriptFileName(file.name) && !referencedPaths.has(file.canonicalPath) || isTrajectorySessionArtifactName(file.name) && !referencedPaths.has(file.canonicalPath) || isPrimarySessionTranscriptFileName(file.name) && !referencedPaths.has(file.canonicalPath)).toSorted((a, b) => a.mtimeMs - b.mtimeMs);
	...
	if (total > highWaterBytes) {
		...
		for (const key of keys) {
			...
			if (!entry) continue;
			if (isProtectedSessionMaintenanceEntry(key, entry)) continue;
...
async function drainSessionStoreWriterQueue(storePath) {
	...
	queue.drainPromise = (async () => {
		try {
			...
			if (queue.pending.length === 0) WRITER_QUEUES.delete(storePath);
			else queueMicrotask(() => {
...
function loadTrajectoryCleanupRuntime() {
	trajectoryCleanupRuntimePromise ??= import("./cleanup-DbGY5-v-.js");
...
//#endregion
export { buildGroupDisplayName as _, updateLastRoute as a, clearSessionStoreCacheForTest as c, resolveSessionStoreEntry as d, enforceSessionDiskBudget as f, snapshotSessionOrigin as g, deriveSessionOrigin as h, saveSessionStore as i, drainSessionStoreWriterQueuesForTest as l, deriveSessionMetaPatch as m, readSessionUpdatedAt as n, updateSessionStore as o, deriveGroupSessionPatch as p, recordSessionMetaFromInbound as r, updateSessionStoreEntry as s, archiveRemovedSessionTranscripts as t, normalizeStoreSessionKey as u, resolveGroupSessionKey as v };
