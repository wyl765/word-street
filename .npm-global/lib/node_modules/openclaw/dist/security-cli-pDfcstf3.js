...
import { d as createIcaclsResetCommand, f as formatIcaclsResetCommand } from "./audit-fs-BPWeHhWB.js";
...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-D2Zp4Y2g.js";
import { t as formatHelpExamples } from "./help-format-y64qVlFX.js";
import { t as runSecurityAudit } from "./audit-COOruRB4.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-BibfNys3.js");
