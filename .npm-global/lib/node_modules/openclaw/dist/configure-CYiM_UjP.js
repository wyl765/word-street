...
import { t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-C1_Y0cDn.js";
import { i as formatErrorMessage } from "./errors-QN8rySzW.js";
import { t as createLazyImportLoader } from "./lazy-promise-AiZRy56y.js";
import { t as formatCliCommand } from "./command-format-ut6bcRZg.js";
import { g as shortenHomePath, p as resolveUserPath, x as isPlainObject } from "./utils-D5swhEXt.js";
import { c as isValidEnvSecretRefId, s as isSecretRef } from "./types.secrets-BlhtUuXT.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-Cut-MFnk.js";
...
import { t as ConfigMutationConflictError } from "./mutate-Bxs3K-kM.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-DYyturhO.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-EAQg2xuP.js";
import { n as applyAuthChoice } from "./auth-choice-CfGxd5Qw.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CUPCJzwE.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DfBWbLsg.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DaGzAlF1.js";
import { t as promptCustomApiConfig } from "./onboard-custom-DoxjEbzm.js";
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CxoLok80.js";
import { t as setupSkills } from "./onboard-skills-CRtRzPYt.js";
...
async function promptAuthConfig(cfg, runtime, prompter) {
	...
	if (authChoice !== "custom-api-key") {
		...
		const allowlistSelection = await promptModelAllowlist({
			...
			loadCatalog: modelPrompt?.loadCatalog ?? (hasConfiguredProviderModels(next, promptProvider) || hasStaticManifestCatalogRows(next, promptProvider))
		});
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-DtvnxiQk.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Ck-MI-Dt.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-BG3QtWJc.js");
...
//#endregion
export { buildGatewayAuthConfig as n, CONFIGURE_WIZARD_SECTIONS as r, configureCommandFromSectionsArg as t };
