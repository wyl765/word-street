...
import { i as callGateway, u as randomIdempotencyKey } from "./call-CGGbETeo.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-DL6VwwSr.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-DPv4VFJ-.js";
import { r as loadModelCatalog } from "./model-catalog-Cq9AzsQW.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-BNqgx5w7.js";
import { D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-r-VWTF89.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-BWT4lLdn.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-Djruh5lS.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-BxiiAXUy.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Bv94H5xR.js";
...
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-jhTfm5KA.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-2m6_igY_.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-B2npd_Dl.js";
	...
	const outputs = await Promise.all(result.videos.map(async (video, index) => {
		...
		if (!videoBuffer && video.url) {
			...
			if (params.output && response.body) {
				...
				await fs$1.mkdir(path.dirname(filePath), { recursive: true });
				await pipeline$1(Readable.fromWeb(response.body), createWriteStream(filePath));
