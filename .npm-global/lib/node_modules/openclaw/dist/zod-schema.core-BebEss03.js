...
import { a as formatExecSecretRefIdValidationMessage, o as isValidExecSecretRefId, s as isValidFileSecretRefId } from "./ref-contract-iNNZovFP.js";
...
const ModelPricingConfigSchema = z.object({ enabled: z.boolean().optional() }).strict().optional();
...
const VisibleRepliesSchema = z.union([VisibleRepliesValueSchema, z.boolean()]).overwrite((value) => {
...
const TtsPersonaPromptSchema = z.object({
...
const TtsPersonaSchema = z.object({
	label: z.string().optional(),
	description: z.string().optional(),
	provider: TtsProviderSchema.optional(),
	fallbackPolicy: z.union([
		z.literal("preserve-persona"),
		z.literal("provider-defaults"),
		z.literal("fail")
	]).optional(),
...
const CliBackendOutputLimitsSchema = z.object({
	maxTurnRawChars: z.number().int().min(1024).max(64 * 1024 * 1024).optional(),
	maxTurnLines: z.number().int().min(100).max(1e5).optional()
}).strict().optional();
