...
import { a as sanitizeTaskStatusText, i as formatTaskStatusTitleText } from "./task-status-D9uGRVqG.js";
...
function openFlowRegistryDatabase() {
	...
	if (cachedDatabase$1) {
		cachedDatabase$1.walMaintenance.close();
...
function loadTaskRegistryDeliveryRuntime() {
	...
	deliveryRuntimePromise ??= import("./task-registry-delivery-runtime-DRUmjxu9.js");
...
function resolveTaskAgentId(params) {
	return normalizeOptionalString(params.explicitAgentId) ?? parseAgentSessionKey(params.ownerKey)?.agentId ?? parseAgentSessionKey(params.requesterSessionKey)?.agentId;
}
...
//#endregion
export { failFlow as A, setFlowWaiting as B, resolveTaskForLookupToken as C, createManagedTaskFlow as D, updateTaskNotifyPolicyById as E, listTaskFlowRecords as F, listTaskFlowsForOwnerKey as I, requestFlowCancel as L, finishFlow as M, getTaskFlowById as N, createTaskFlowForTask as O, getTaskFlowRegistryRestoreFailure as P, resolveTaskFlowForLookupToken as R, reloadTaskRegistryFromStore as S, setTaskRunDeliveryStatusByRunId as T, updateFlowRecordByIdExpectedRevision as V, markTaskLostById as _, finalizeTaskRunByRunId as a, maybeDeliverTaskTerminalUpdate as b, hasActiveTaskForChildSessionKey as c, listTaskRecords as d, listTasksForAgentId as f, listTasksForSessionKey as g, listTasksForRelatedSessionKey as h, ensureTaskRegistryReady as i, findLatestTaskFlowForOwnerKey as j, deleteTaskFlowRecordById as k, isParentFlowLinkError as l, listTasksForOwnerKey as m, createTaskRecord as n, findTaskByRunId as o, listTasksForFlowId as p, deleteTaskRecordById as r, getTaskById as s, cancelTaskById as t, linkTaskToFlowById as u, markTaskRunningByRunId as v, setTaskCleanupAfterById as w, recordTaskProgressByRunId as x, markTaskTerminalById as y, resumeFlow as z };
