import { s as __toESM, t as __commonJSMin } from "./chunk-A-jGZS85.js";
import { t as require_src } from "./src-C20CTZIX.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-CEeTc3by.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-D2hUhFDf.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-C6ZOIAH3.js";
import { l as toRatio, n as decodeString } from "./Util-Zh2_NoLs.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CcAfeyDq.js";
import { t as APEv2Parser } from "./APEv2Parser-D2vODd57.js";
import { r as hasID3v1Header } from "./ID3v1Parser-Dup2a7qW.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-VTqQc3PH.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-m3Ba3IoX.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-tcxTjGEs.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-tZjE7YQ_.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CFwFJ_Mc.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Cp6V2a3Y.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-YKlXE4-d.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-w862BeEz.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-BO8XdUG4.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BDOg1BaL.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-pU7IUrmR.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-B-60Nxgs.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BOwmzjje.js")).WaveParser;
	}
};
//#endregion
...
//#endregion
export { scanAppendingHeaders as a, parseFromTokenizer as i, parseStream as n, parseBuffer as r, parseFile as t };
