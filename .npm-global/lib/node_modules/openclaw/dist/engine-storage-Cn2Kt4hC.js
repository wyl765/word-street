...
import { t as configureSqliteWalMaintenance } from "./sqlite-wal-DMug4B7X.js";
import { r as normalizeOptionalString } from "./string-utils-NbhR9yIX.js";
import { t as formatErrorMessage } from "./error-utils-rvP1XoKr.js";
import "./internal-g5sy5JDb.js";
import "./openclaw-runtime-io-Dp_GzWQa.js";
import "./read-file-D5IDCM3N.js";
...
async function loadSqliteVecExtension(params) {
	try {
		...
		const message = formatErrorMessage(err);
		if (isMissingSqliteVecPackageError(err)) return {
			ok: false,
