...
import { n as applyHuggingfaceConfig, t as HUGGINGFACE_DEFAULT_MODEL_REF } from "../../onboard-1KjepBU9.js";
import { t as buildHuggingfaceProvider } from "../../provider-catalog-Bl_om4U4.js";
	...
	provider: {
		...
		catalog: {
			...
			run: async (ctx) => {
				...
				if (((pluginEntry && typeof pluginEntry === "object" && pluginEntry.config ? pluginEntry.config : void 0)?.discovery?.enabled ?? ctx.config?.models?.huggingfaceDiscovery?.enabled) === false) return null;
