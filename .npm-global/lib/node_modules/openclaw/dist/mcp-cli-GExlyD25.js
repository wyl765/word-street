...
import { i as extractFirstTextBlock } from "./chat-message-content-CafY5b6-.js";
...
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-BDiNm6bg.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-t0Uic28p.js"),
			import("./client-DvGS4ZBE.js"),
			import("./client-start-readiness-BAcA5Zc5.js"),
			import("./method-scopes-HQQsDRee.js"),
			import("./client-info-DO8Vq4zI.js")
		]);
