import { S as createToolStreamWrapper, o as createHtmlEntityToolCallArgumentDecodingWrapper, t as composeProviderStreamWrappers } from "./provider-stream-shared-3uSo6qFL.js";
...
function createXaiToolPayloadCompatibilityWrapper(baseStreamFn) {
	...
	return (model, context, options) => {
		const transportModel = model.provider === "xai" && model.reasoning ? {
			...model,
			reasoning: false
		} : model;
