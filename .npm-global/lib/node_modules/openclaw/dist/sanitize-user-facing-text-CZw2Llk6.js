...
import { a as parseApiErrorInfo, i as isCloudflareOrHtmlErrorPage, n as extractLeadingHttpStatus, o as parseApiErrorPayload, r as formatRawAssistantErrorForUi } from "./assistant-error-format-Dn2Sbeud.js";
import { t as coerceChatContentText } from "./chat-content-CBB0xDuV.js";
import { c as stripToolCallXmlTags, o as stripLegacyBracketToolCallBlocks, s as stripMinimaxToolCallXml } from "./assistant-visible-text-IOthCE6f.js";
import { c as isTimeoutErrorMessage, i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-ylz9XX5D.js";
...
function sanitizeUserFacingText(text, opts) {
	...
	const withoutToolCallBlocks = stripLegacyBracketToolCallBlocks(stripToolCallsOmittedPlaceholderLines(stripToolCallXmlTags(stripMinimaxToolCallXml(stripInboundMetadata(stripInternalRuntimeContext(stripFinalTagsFromText(raw)))), { stripFunctionCallsXmlPayloads: true })));
...
//#endregion
export { formatTransportErrorCopy as a, isLikelyHttpErrorText as c, sanitizeUserFacingText as d, stableStringify as f, parseExecApprovalResultText as h, formatRateLimitOrOverloadedErrorCopy as i, isRawApiErrorPayload as l, isExecDeniedResultText as m, formatBillingErrorMessage as n, getApiErrorPayloadFingerprint as o, formatExecDeniedUserMessage as p, formatDiskSpaceErrorCopy as r, isInvalidStreamingEventOrderError as s, BILLING_ERROR_USER_MESSAGE as t, isStreamingJsonParseError as u };
