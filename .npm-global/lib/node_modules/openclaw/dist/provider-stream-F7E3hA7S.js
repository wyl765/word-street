...
import { _ as createMinimaxFastModeWrapper, a as createCodexNativeWebSearchWrapper, c as createOpenAIFastModeWrapper, d as createOpenAIServiceTierWrapper, f as createOpenAIStringContentWrapper, g as resolveOpenAIServiceTier, h as resolveOpenAIFastMode, i as isProxyReasoningUnsupported, l as createOpenAIReasoningCompatibilityWrapper, m as createOpenAIThinkingLevelWrapper, o as createOpenAIAttributionHeadersWrapper, p as createOpenAITextVerbosityWrapper, r as createOpenRouterWrapper, t as createKilocodeWrapper, u as createOpenAIResponsesContextManagementWrapper, y as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-CoOYKeHd.js";
import { h as resolveMoonshotThinkingType, m as resolveMoonshotThinkingKeep, p as createMoonshotThinkingWrapper } from "./provider-model-shared-CBs97vBP.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-BHhDFVgT.js";
import { S as createToolStreamWrapper, i as createGoogleThinkingPayloadWrapper } from "./provider-stream-shared-3uSo6qFL.js";
...
function parseModel(model) {
	...
	return {
		...
		cost: {
			input: Number.parseFloat(model.pricing?.prompt || "0") * 1e6,
			output: Number.parseFloat(model.pricing?.completion || "0") * 1e6,
			cacheRead: Number.parseFloat(model.pricing?.input_cache_read || "0") * 1e6,
			cacheWrite: Number.parseFloat(model.pricing?.input_cache_write || "0") * 1e6
		}
	};
}
