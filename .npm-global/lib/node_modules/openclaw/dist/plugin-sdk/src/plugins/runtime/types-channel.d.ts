...
import type { ReadChannelAllowFromStoreForAccount, UpsertChannelPairingRequestForAccount } from "../../pairing/pairing-store.types.js";
type ShouldHandleTextCommands = import("../../auto-reply/commands-registry.runtime-types.js").ShouldHandleTextCommands;
type IsControlCommandMessage = import("../../auto-reply/command-detection.runtime-types.js").IsControlCommandMessage;
type ShouldComputeCommandAuthorized = import("../../auto-reply/command-detection.runtime-types.js").ShouldComputeCommandAuthorized;
type BuildMentionRegexes = import("../../auto-reply/reply/mentions.types.js").BuildMentionRegexes;
type MatchesMentionPatterns = import("../../auto-reply/reply/mentions.types.js").MatchesMentionPatterns;
type MatchesMentionWithExplicit = import("../../auto-reply/reply/mentions.types.js").MatchesMentionWithExplicit;
type ReadSessionUpdatedAt = import("../../config/sessions/runtime-types.js").ReadSessionUpdatedAt;
type RecordSessionMetaFromInbound = import("../../config/sessions/runtime-types.js").RecordSessionMetaFromInbound;
...
export type RuntimeThreadBindingLifecycleRecord = import("../../infra/outbound/session-binding.types.js").SessionBindingRecord | {
    boundAt: number;
