...
import type { ListSpeechVoices, TextToSpeech, TextToSpeechTelephony } from "../../plugin-sdk/tts-runtime.types.js";
import type { PluginRuntimeTaskFlows, PluginRuntimeTaskRuns } from "./runtime-tasks.types.js";
export type { HeartbeatRunResult };
export type RuntimeRequestHeartbeatOptions = Parameters<typeof import("../../infra/heartbeat-wake.js").requestHeartbeat>[0];
export type RuntimeRequestHeartbeatNowOptions = Omit<RuntimeRequestHeartbeatOptions, "source" | "intent"> & Partial<Pick<RuntimeRequestHeartbeatOptions, "source" | "intent">>;
...
type RuntimeMutateConfigFileParams<T = void> = {
    ...
    mutate: (draft: import("../../config/types.openclaw.js").OpenClawConfig, context: RuntimeConfigMutationContext) => Promise<T | void> | T | void;
};
...
type RuntimeRunEmbeddedPiAgent = (params: import("../../agents/pi-embedded-runner/run/params.js").RunEmbeddedPiAgentParams) => Promise<import("../../agents/pi-embedded-runner/types.js").EmbeddedPiRunResult>;
...
export type PluginRuntimeCore = {
    ...
    config: {
         ...
         * deprecated-internal-config-api architecture guard.
         */
        writeConfigFile: (cfg: import("../../config/types.openclaw.js").OpenClawConfig, options?: RuntimeWriteConfigOptions & {
            afterWrite?: RuntimeConfigAfterWrite;
        }) => Promise<void>;
    };
    agent: {
        ...
        normalizeThinkingLevel: (raw?: string | null) => import("../../auto-reply/thinking.js").ThinkLevel | undefined;
    ...
    imageGeneration: {
        generate: (params: import("../../image-generation/runtime-types.js").GenerateImageParams) => Promise<import("../../image-generation/runtime-types.js").GenerateImageRuntimeResult>;
        listProviders: (params?: import("../../image-generation/runtime-types.js").ListRuntimeImageGenerationProvidersParams) => import("../../image-generation/runtime-types.js").RuntimeImageGenerationProvider[];
    };
    videoGeneration: {
        generate: (params: import("../../video-generation/runtime-types.js").GenerateVideoParams) => Promise<import("../../video-generation/runtime-types.js").GenerateVideoRuntimeResult>;
        listProviders: (params?: import("../../video-generation/runtime-types.js").ListRuntimeVideoGenerationProvidersParams) => import("../../video-generation/runtime-types.js").RuntimeVideoGenerationProvider[];
    };
    musicGeneration: {
        generate: (params: import("../../music-generation/runtime-types.js").GenerateMusicParams) => Promise<import("../../music-generation/runtime-types.js").GenerateMusicRuntimeResult>;
        listProviders: (params?: import("../../music-generation/runtime-types.js").ListRuntimeMusicGenerationProvidersParams) => import("../../music-generation/runtime-types.js").RuntimeMusicGenerationProvider[];
    };
    webSearch: {
        listProviders: (params?: import("../../web-search/runtime-types.js").ListWebSearchProvidersParams) => import("../../web-search/runtime-types.js").RuntimeWebSearchProviderEntry[];
        search: (params: import("../../web-search/runtime-types.js").RunWebSearchParams) => Promise<import("../../web-search/runtime-types.js").RunWebSearchResult>;
    };
    stt: {
        transcribeAudioFile: MediaUnderstandingRuntime["transcribeAudioFile"];
    };
    ...
    state: {
        ...
        openKeyedStore: <T>(options: import("../../plugin-state/plugin-state-store.types.js").OpenKeyedStoreOptions) => import("../../plugin-state/plugin-state-store.types.js").PluginStateKeyedStore<T>;
    };
    tasks: {
