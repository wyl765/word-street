...
export type EmbeddedPiSubscribeContext = {
    ...
    consumePartialReplyDirectives: (text: string, options?: {
        final?: boolean;
    }) => ReplyDirectiveParseResult | null;
 ...
 */
type ToolHandlerParams = Pick<SubscribeEmbeddedPiSessionParams, "runId" | "onBlockReplyFlush" | "onAgentEvent" | "onToolResult" | "sessionKey" | "sessionId" | "agentId" | "toolResultFormat" | "toolProgressDetail">;
type ToolHandlerState = Pick<EmbeddedPiSubscribeState, "toolMetaById" | "toolMetas" | "toolSummaryById" | "itemActiveIds" | "itemStartedCount" | "itemCompletedCount" | "lastToolError" | "pendingMessagingTargets" | "pendingMessagingTexts" | "pendingMessagingMediaUrls" | "pendingToolMediaUrls" | "pendingToolAudioAsVoice" | "pendingToolTrustedLocalMedia" | "deterministicApprovalPromptPending" | "replayState" | "messagingToolSentTexts" | "messagingToolSentTextsNormalized" | "messagingToolSentMediaUrls" | "messagingToolSentTargets" | "heartbeatToolResponse" | "successfulCronAdds" | "deterministicApprovalPromptSent">;
