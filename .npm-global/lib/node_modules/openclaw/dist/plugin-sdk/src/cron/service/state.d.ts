...
import type { CronDeliveryStatus, CronDeliveryTrace, CronJob, CronJobCreate, CronJobPatch, CronRunDiagnostics, CronMessageChannel, CronAgentExecutionStarted, CronRunOutcome, CronRunStatus, CronRunTelemetry, CronStoreFile } from "../types.js";
...
export declare function createCronServiceState(deps: CronServiceDeps): CronServiceState;
