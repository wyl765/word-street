export declare function redactConfigAuditArgv(argv: readonly string[]): string[];
export declare function snapshotConfigAuditProcessInfo(): ConfigAuditProcessInfo;
...
type ConfigWriteAuditRecordBase = Omit<ConfigWriteAuditRecord, "result" | "nextDev" | "nextIno" | "nextMode" | "nextNlink" | "nextUid" | "nextGid" | "errorCode" | "errorMessage"> & {
    nextHash: string;
    nextBytes: number;
};
type ConfigAuditFs = {
