...
export type ToolAvailabilityExpression = ToolAvailabilitySignal | {
...
export type ToolUnavailableReason = "auth-missing" | "config-missing" | "context-mismatch" | "env-missing" | "plugin-disabled" | "unsupported-signal";
