...
import { t as require_safe_buffer } from "./safe-buffer-BKS2jhbt.js";
...
var require_combined_stream = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	util$1.inherits(CombinedStream, Stream);
...
//#endregion
//#region node_modules/form-data/node_modules/mime-db/db.json
...
//#endregion
//#region node_modules/form-data/node_modules/mime-db/index.js
...
//#endregion
//#region node_modules/form-data/node_modules/mime-types/index.js
/*!
* mime-types
* Copyright(c) 2014 Jonathan Ong
...
var require_form_data = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	FormData.prototype._trackLength = function(header, value, options) {
		...
		if (!value || !value.path && !(value.readable && hasOwn(value, "httpVersion"))) return;
		if (!options.knownLength) this._valuesToMeasure.push(value);
	};
	FormData.prototype._lengthRetriever = function(value, callback) {
		if (hasOwn(value, "fd")) if (value.end != null && value.end !== Infinity && value.start != null) callback(null, value.end + 1 - (value.start ? value.start : 0));
...
//#endregion
export { require_type as i, require_get_intrinsic as n, require_call_bind_apply_helpers as r, require_form_data as t };
